...
(function () {
  ...
  // Il segnale d'ambiente (il bollo arancione "DEV") stava qui, e percio'
  // mancava su tutte le pagine senza menu'. Ora vive in dev.js, che ogni
  // pagina include per conto suo: una casa sola, e vale ovunque.
